...
jump_statement
	...
	| RETURN initializer ';' {if(current_level==lvl_name.size()){get_type_id(check_if_function(lvl_name.top()));}else{cout << "return not allowed here" << endl;exit(0);} check_compatibility($2,func_ret_type);$$=$2;}
	;
